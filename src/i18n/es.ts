export default {
  ...
  notifications: {
    ...
    permissionDenied: "Helm necesita tu aprobación para enviar notificaciones. Actívalo en la configuración de tu dispositivo.",
    status: "ESTADO",
    statusGranted: "Activadas",
    statusDenied: "Desactivadas",
    descriptionGranted: "Recibirás notificaciones sobre tus transacciones, alertas de seguridad y actualizaciones importantes.",
    descriptionDenied: "Activa las notificaciones para recibir actualizaciones sobre tus transacciones y alertas importantes.",
    everythingReady: "¡Todo listo! Estás recibiendo notificaciones.",
    enable: "Activar Notificaciones",
    openSettings: "Abrir Configuración",
    whyNeeded: "¿POR QUÉ ES NECESARIO?",
    whyDescription: "Las notificaciones te ayudan a estar informado sobre:\n\n• Nuevas transacciones recibidas\n• Confirmación de retiros\n• Alertas de seguridad\n• Actualizaciones importantes",
    enabled: "¡Notificaciones activadas exitosamente!",
    requiresSettings: "Abre la configuración de tu dispositivo para activar.",
    enableError: "No se pudieron activar las notificaciones.",
    settingsError: "No se pudo abrir la configuración.",
  },
};
