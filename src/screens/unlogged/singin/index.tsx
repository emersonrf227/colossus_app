...
//       // reset() (não navigate()) é proposital aqui: limpa todo o
//       // histórico de navegação, deixando o Dashboard como única tela na
//       // pilha. Sem isso, o login ficaria empilhado por baixo do
//       // Dashboard, e o botão de voltar (ou gesto/hardware back no
//       // Android) levaria o usuário de volta para a tela de login mesmo
...
//       setLoading(false);
//     }
//   }, [identifier, password, signIn, showToast, reset]);
